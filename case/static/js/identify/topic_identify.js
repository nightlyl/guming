...
function create_current_table(data, start_row, end_row, type) {
    ...
    var thead = '<thead><tr><th>排名</th><th style="display:none">博主ID</th><th>博主昵称</th><th>博主地域</th><th>粉丝数</th><th>关注数</th><th>PR值</th><th>度中心性</th><th>介数中心性</th><th>紧密中心性</th><th>捷径两端点用户</th><th>源头用户</th><th>意见领袖</th><th>趋势发起人</th></tr></thead>';
    var tbody = '<tbody>';
    ...
    function gettimeline_data() {
        ...
        function drawtable(data){
                ...
                for (var topic in topic_child_keywords){
                    ...
                    if (topic_child_keywords[topic].length>=15){
                      total = 15;
                    }
                    else{
                      total = topic_child_keywords[topic].length;
